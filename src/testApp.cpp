...
//		vidGrabber.draw(thumbPos.x, thumbPos.y, 160, 120);
		...
		ofDrawBitmapString("How are we feeling today?", lutPos.x, -lutPos.y+75);
        
        ofDrawBitmapString("Press the space bar to feel normal. Press up and down arrows to explore emotions.", lutPos.x, -lutPos.y+100);
